...
import net.omar.onlineshopping.exception.ProductNotFoundException;
...
public class PageController {
	...
	public ModelAndView showSingleProduct(@PathVariable int id) throws ProductNotFoundException{
		...
		//Update the product views count
		int numberOfViews = product.getViews();
		product.setViews(++numberOfViews);
